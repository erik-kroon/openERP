...
Conservative limitation: any book ledger/configuration change or changed represented impact invalidates a snapshot. Legacy/present register relationships remain blocked even if another owner's future compensation release exists, until that owner supplies an explicit stable integration. This module does not guess release semantics or become a compensation authority. Maximum chain200 vouchers/resources1000 is fail-closed with no partial totals.
