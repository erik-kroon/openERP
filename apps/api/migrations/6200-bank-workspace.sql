...
CREATE FUNCTION openerp.bank_workspace(p_token text,p_scope jsonb,p_query jsonb) RETURNS jsonb
...
BEGIN
 ...
 SELECT coalesce(jsonb_agg(jsonb_build_object(
  ...
  'differenceMinor',CASE WHEN st.ends_on=d_to THEN (l.balance-(st.source->>'closingMinor')::numeric)::text END,
