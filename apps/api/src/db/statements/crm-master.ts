...
export const crmMasterStatements = {
  ...
  crmDirectoryExport: (parameters) =>
    sql`select openerp.crm_directory_export(${parameters[0]}::text,${parameters[1]}::jsonb,${parameters[2]}::text,${parameters[3]}::text,${parameters[4]}::text) as result`,
