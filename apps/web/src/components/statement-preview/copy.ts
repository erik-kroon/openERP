...
const en = {
  ...
  local: "The file stays in this browser tab. Nothing is uploaded or posted. Save the review before closing or reloading this page.",
  file: "SEB statement CSV",
  format: "UTF-8, newest transactions first, up to 1 MiB and 10,000 transactions. Use the six-column export with booking date, value date, text, type, amount and balance.",
  currency: "Statement currency",
  chooseCurrency: "Select the currency on your bank statement",
  currencyHelp: "This export does not identify its currency. Currently only statements you confirm are in SEK can be reviewed.",
  ...
  downloadHelp: "Keep the downloaded review with the original CSV. It records the file fingerprint and every source row; it is not a bookkeeping import or an archive of the original file.",
  ...
  coverage: "Account identity and complete period coverage are unconfirmed. The last recorded balance does not confirm the balance at your financial year end.",
  ...
  errors: {
    ...
    header: "Choose a SEB export with these columns: Bokförd, Valutadatum, Text, Typ, Insättningar/uttag, Bokfört saldo.",
    ...
    amount: "An amount or balance is invalid. Use a decimal point and exactly two decimal places, without thousands separators.",
    order: "Transactions must be exported newest first. Choose the original SEB export in that order.",
...
const sv: typeof en = {
  ...
  local: "Filen stannar i den här webbläsarfliken. Inget laddas upp eller bokförs. Spara granskningen innan du stänger eller laddar om sidan.",
  file: "SEB-kontoutdrag som CSV",
  format: "UTF-8, senaste transaktionerna först, högst 1 MiB och 10 000 transaktioner. Använd exporten med sex kolumner: bokföringsdatum, valutadatum, text, typ, belopp och saldo.",
  currency: "Kontoutdragets valuta",
  chooseCurrency: "Välj valutan som står på bankens kontoutdrag",
  currencyHelp: "Exporten anger inte valuta. För närvarande kan du granska kontoutdrag som du bekräftar är i SEK.",
  ...
  downloadHelp: "Spara granskningen tillsammans med originalfilen. Den innehåller filens kontrollsumma och alla källrader, men är inte en bokföringsimport eller ett arkiv av originalfilen.",
  source: "Originalfil",
  ...
  coverage: "Kontots identitet och periodens fullständighet är inte bekräftade. Senast angivna saldo bekräftar inte saldot vid räkenskapsårets slut.",
  ...
  errors: {
    ...
    header: "Välj en SEB-export med kolumnerna Bokförd, Valutadatum, Text, Typ, Insättningar/uttag, Bokfört saldo.",
    ...
    amount: "Ett belopp eller saldo är ogiltigt. Använd decimalpunkt och exakt två decimaler utan tusentalsavgränsare.",
    order: "Transaktionerna måste vara exporterade med den senaste först. Välj SEB:s originalexport i den ordningen.",
