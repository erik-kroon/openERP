...
const messages = {
  ...
  currency_unsupported: ["SEK with currency scale 2 is required.", "SEK med valutaskala 2 krävs."],
  missing_dates: [
  ...
  withdrawn_fact: [
    "The source fact was permanently withdrawn. Its retained amounts are excluded.",
    "Faktauppgiften har återkallats permanent. Dess sparade belopp är exkluderade.",
  ],
  reversed_voucher: [
