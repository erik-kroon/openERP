...
export const BankMatchReversalsApi = HttpApiGroup.make("bankMatchReversals").add(
  ...
  HttpApiEndpoint.post(
    ...
    `${path}/bank-match-reversal-plans/:id/approve`,
    {
      ...identifiedMutation,
  ...
  HttpApiEndpoint.post(
    ...
    `${path}/bank-match-reversal-plans/:id/execute`,
    {
      ...identifiedMutation,
  ...
  HttpApiEndpoint.post(
    ...
    `${path}/bank-match-reversal-approvals/:id/revoke`,
    {
      ...identifiedMutation,
      payload: RevokeBankMatchReversalApproval.annotate({
...
export const BankMatchReversalCapabilities = {
  bank_prepare_match_reversal: {
    description:
      "Prepare an immutable whole-allocation or exact unmatch for human review. No ledger or invoice change.",
  ...
  bank_list_match_reversals: {
    description:
      "Discover retained unmatch plans and receipts in this book. Live identifier pages are not a complete source inventory.",
  ...
  bank_execute_match_reversal: {
    description:
      "Execute an exactly human-approved unmatch once. Releases matching capacity while preserving every original relationship.",
    input: Schema.Struct({
      ...capabilityMutation,
      planId: Accounting.Identifier,
      input: ExecuteBankMatchReversal,
    }),
