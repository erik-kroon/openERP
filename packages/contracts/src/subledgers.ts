...
export const PrepareAssetImpairment = Schema.Struct({
  ...
  impairmentMinor: Accounting.MinorUnits,
...
export const AssetDisposal = Schema.Struct({
  ...
  recognizedMinor: Accounting.MinorUnits,
  impairmentMinorReleased: Schema.optional(Accounting.MinorUnits),
...
export const AssetImpairment = Schema.Struct({
  ...
  accumulatedImpairmentAccountId: Accounting.Identifier,
  postingReceipt: Accounting.ExecutionReceipt,
  status: Schema.Literal("synthetic_impairment"),
  futureRecognitionBlocked: Schema.Literal(false),
  coverage: Schema.Literal("not_established"),
  legalPolicyApproved: Schema.Literal(false),
  createdAt: Schema.String,
  receipt: CommandReceipt,
