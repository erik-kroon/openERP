...
[Partial reviewed line credits](evidence/ap-partial-line-credit-http.md) now consume only unpaid residual after an applied payment, reverse the selected original expense/input-VAT portions, and retain the payment leg. Paid-principal refunds remain unsupported.
